          ...
          <div className="flex justify-between">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <Link 
                  href="https://www.facebook.com/share/172vZ8zivP/?mibextid=wwXIfr" 
                ...
                <Link 
                  href="https://www.instagram.com/rever.egypt?igsh=djdicjB5dW11aWYz" 
                  className="text-gray-300 hover:text-white transition-colors inline-block"
                ...
                <Link 
                  href="https://www.tiktok.com/@rever.egypt?_t=ZS-8zo6VLXqeK0&_r=1" 
                  className="text-gray-300 hover:text-white transition-colors inline-block"
                  aria-label="TikTok"
                  target="_blank"
                >
