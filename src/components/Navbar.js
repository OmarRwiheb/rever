          ...
          <div className="hidden lg:flex items-center justify-end w-1/3 space-x-4">
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-2 -right-3 bg-black text-white text-[10px] font-bold rounded-full min-w-[16px] h-4 flex items-center justify-center px-1 shadow-sm border border-white">
                  {getItemCount()}
                </div>
              </div>
            </button>
              ...
              <div className="mx-0 px-4 sm:px-6 lg:px-8 flex-shrink-0">
                <div className="flex justify-between items-center h-16 lg:h-20 z-20 relative">
                  ...
                  <div className="flex-1 flex justify-center lg:justify-center">
                    <a href="/" className="text-center">
                      <h1 className="text-2xl lg:text-3xl font-awaken text-black tracking-wider transition-all duration-500 ease-out">
                        REVER
                      </h1>
                    </a>
                  </div>
